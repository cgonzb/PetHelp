...
class enfermedad {
     ...
     */
    public $tableName = 'enfermedad';
    public $headers = ["idEnfermedad", "Nombre", "Descripcion", "Ultima_Mod"];
    public $ultima_mod = 'NOW()';

    public function __construct($idEnfermedad = 'null', $nombre = 'null', $descripcion = 'null') {
    ...
    public function update() {
        /**
         * @return boolean actualiza la enfermedad
         */
