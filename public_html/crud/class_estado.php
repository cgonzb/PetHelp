...
class estado {
    ...
    public $headers = ["idEstado", "Nombre", "Descripcion", "Ultima_Mod"];
    public $ultima_mod = 'NOW()';

    public function __construct($idEstado = 'null', $nombre = 'null', $descripcion = 'null') {
        $this->id = $idEstado;
        $this->nombre = $nombre;
    ...
    public function update() {
        /**
         * @return boolean actualiza la estado
         */
    ...
    public function getAll() {
        /**
         * 
         * @return array|false devuelve todas las estadoes o falso si no hay
         */
        //incluye la conexion a la base de datos
        require_once dirname(__FILE__) . '/../config/dbconfig.php';
        /**
