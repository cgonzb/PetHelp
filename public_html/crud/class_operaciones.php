...
class operaciones {
     ...
     */
    public $tableName = 'operaciones';
    public $headers = ["idOperaciones", "Nombre", "Descripcion", "Ultima_Mod"];
    public $ultima_mod = 'NOW()';

    public function __construct($idOperaciones = 'null', $nombre = 'null', $descripcion = 'null') {
        $this->id = $idOperaciones;
        $this->nombre = $nombre;
    ...
    public function update() {
        /**
         * @return boolean actualiza la operaciones
         */
    ...
    public function getAll() {
        /**
         * 
         * @return array|false devuelve todas las operacioneses o falso si no hay
         */
        //incluye la conexion a la base de datos
        require_once dirname(__FILE__) . '/../config/dbconfig.php';
        /**
