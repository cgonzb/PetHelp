...
class vacunas {
     ...
     */
    public $tableName = 'vacunas';
    public $headers = ["idVacunas", "Nombre", "Descripcion", "Ultima_Mod"];
    public $ultima_mod = 'NOW()';

    public function __construct($idVacunas = 'null', $nombre = 'null', $descripcion = 'null') {
        $this->id = $idVacunas;
        $this->nombre = $nombre;
    ...
    public function update() {
        /**
         * @return boolean actualiza la vacunas
         */
    ...
    public function getAll() {
        /**
         * 
         * @return array|false devuelve todas las vacunases o falso si no hay
         */
        //incluye la conexion a la base de datos
        require_once dirname(__FILE__) . '/../config/dbconfig.php';
        /**
